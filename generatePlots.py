...
colors = ['black','darkred', 'firebrick','brown','indianred','forestgreen','olivedrab','fuchsia','orchid','mediumvioletred']
...
info_dir = base_dir + "/crossover_info"
...
axes.set_ylabel("Number of Reads")
axes.set_title("Distribution of Crossover Positions on High Quality Crossover Reads (n = " + str(n) + ")")
plt.savefig(plots_dir + "/hqcrossover.png")